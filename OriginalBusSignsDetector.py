...
class Ui_MainWindow(QDialog):
    def setupUi(self, MainWindow):
        ...
        self.right_picture.setGeometry(QRect(600*ratio, 50*ratio, 491*ratio, 631*ratio))
        self.right_picture.setFrameShape(QFrame.Box)
        self.line = QFrame(self.centralwidget)
        self.line.setObjectName(u"line")
        self.line.setGeometry(QRect(560*ratio, 20*ratio, 20*ratio, 721*ratio))
        self.line.setFrameShape(QFrame.VLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(220*ratio, 130*ratio, 150, 20))
        self.label.setIndent(-1)
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(790*ratio, 20*ratio, 150, 20))
        self.label_2.setIndent(-1)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName("menubar")
        self.menubar.setGeometry(QRect(0, 0, 1137*ratio, 22*ratio))
